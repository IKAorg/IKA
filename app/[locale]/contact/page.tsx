...
> = {
  ...
  es: {
    ...
    message: "Mensaje",
    submit: "Enviar",
    note: "El mensaje se abrira en tu aplicacion de email antes de enviarse.",
  },
  it: {
    ...
    message: "Messaggio",
    submit: "Invia",
    note: "Il messaggio si aprira nella tua applicazione email prima dell'invio.",
  },
  fr: {
  ...
  cs: {
    required: "oznacuje povinne pole",
    name: "Jmeno",
    email: "Email",
    message: "Zprava",
    submit: "Odeslat",
    note: "Zprava se pred odeslanim otevre ve vasi emailove aplikaci.",
  },
};
