...
grant execute on function app.current_member_id() to anon, authenticated;
...
grant execute on function app.can_manage_country(uuid) to anon, authenticated;
grant execute on function app.can_manage_dojo(uuid) to anon, authenticated;
