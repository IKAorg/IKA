...
export const extendedOfficialInstructorsPageCopy: Partial<Record<Locale, Record<string, string>>> = {
  id: { eyebrow: "Instruktur resmi", title: "Instruktur resmi IKA", intro: "Kenali instruktur resmi IKA.", gradeLabel: "Tingkat", countryLabel: "Negara asal", noGrade: "Instruktur terkonfirmasi", empty: "Belum ada instruktur resmi yang dipublikasikan.", chiefBadge: "Instruktur Utama IKA", officialBadge: "Instruktur resmi IKA", instructorsSection: "Instruktur resmi", examinersSection: "Penguji resmi", judgesSection: "Juri resmi", officialExaminerBadge: "Penguji resmi IKA", officialJudgeBadge: "Juri resmi IKA" },
  ms: { eyebrow: "Jurulatih rasmi", title: "Jurulatih rasmi IKA", intro: "Kenali jurulatih rasmi IKA.", gradeLabel: "Gred", countryLabel: "Negara asal", noGrade: "Jurulatih disahkan", empty: "Belum ada jurulatih rasmi yang diterbitkan.", chiefBadge: "Ketua Jurulatih IKA", officialBadge: "Jurulatih rasmi IKA", instructorsSection: "Jurulatih rasmi", examinersSection: "Pemeriksa rasmi", judgesSection: "Hakim rasmi", officialExaminerBadge: "Pemeriksa rasmi IKA", officialJudgeBadge: "Hakim rasmi IKA" },
  eu: { eyebrow: "Irakasle ofizialak", title: "IKAko irakasle ofizialak", intro: "Ezagutu IKAko irakasle ofizialak.", gradeLabel: "Gradua", countryLabel: "Jatorrizko herrialdea", noGrade: "Baieztatutako irakaslea", empty: "Oraindik ez dago argitaratutako irakasle ofizialik.", chiefBadge: "IKAko irakasle nagusia", officialBadge: "IKAko irakasle ofiziala", instructorsSection: "Irakasle ofizialak", examinersSection: "Aztertzaile ofizialak", judgesSection: "Epaile ofizialak", officialExaminerBadge: "IKAko aztertzaile ofiziala", officialJudgeBadge: "IKAko epaile ofiziala" },
  pt: { eyebrow: "Instrutores oficiais", title: "Instrutores oficiais da IKA", intro: "Conheça os instrutores oficiais da IKA.", gradeLabel: "Grau", countryLabel: "País de origem", noGrade: "Instrutor confirmado", empty: "Ainda não existem instrutores oficiais publicados.", chiefBadge: "Instrutor-Chefe da IKA", officialBadge: "Instrutor oficial IKA", instructorsSection: "Instrutores oficiais", examinersSection: "Examinadores oficiais", judgesSection: "Juízes oficiais", officialExaminerBadge: "Examinador oficial IKA", officialJudgeBadge: "Juiz oficial IKA" },
  de: { eyebrow: "Offizielle Instruktoren", title: "Offizielle IKA-Instruktoren", intro: "Lernen Sie die offiziellen IKA-Instruktoren kennen.", gradeLabel: "Grad", countryLabel: "Herkunftsland", noGrade: "Bestätigter Instruktor", empty: "Es sind noch keine offiziellen Instruktoren veröffentlicht.", chiefBadge: "IKA-Chefausbilder", officialBadge: "Offizieller IKA-Instruktor", instructorsSection: "Offizielle Instruktoren", examinersSection: "Offizielle Prüfer", judgesSection: "Offizielle Kampfrichter", officialExaminerBadge: "Offizieller IKA-Prüfer", officialJudgeBadge: "Offizieller IKA-Kampfrichter" },
};
