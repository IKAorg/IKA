...
export function AdminPanel({ locale }: AdminPanelProps) {
  ...
  useEffect(() => {
    ...
    const {
      ...
      const sameUserSession = Boolean(nextUserId) && nextUserId === currentUserId;
...
function adminPanelCopy(locale: Locale): AdminPanelCopy {
  const dictionaries: Partial<Record<Locale, Partial<AdminPanelCopy>>> = {
    en: {
      ...
      directorGateTitle: "Admin PIN validation",
      directorGateIntro: "Select your admin profile and enter your personal PIN before using super admin.",
      directorSelectLabel: "Admin profile",
      ...
      directorRequired: "Select admin",
      directorPanelTitle: "Super admin PINs",
      directorPanelIntro: "Create internal admin profiles, activate or deactivate access, and reset personal PINs.",
      directorName: "Admin name",
      directorPin: "PIN",
    ...
    es: {
      ...
      directorGateTitle: "Validacion PIN de admin",
      directorGateIntro: "Selecciona tu perfil de admin e introduce tu PIN personal antes de usar super admin.",
      directorSelectLabel: "Perfil de admin",
      ...
      directorRequired: "Selecciona admin",
      directorPanelTitle: "PIN de admins super admin",
      directorPanelIntro: "Crea perfiles internos de admin, activa o desactiva accesos y resetea PIN personales.",
      directorName: "Nombre del admin",
      directorPin: "PIN",
